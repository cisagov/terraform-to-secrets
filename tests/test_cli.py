...
"""Tests for the terraform_to_secrets.cli module."""
...
github_pat = "ghp_BqvxkUqqOPNBi9QRAekYqRIonLJmPntu3YBm"
log_levels = (
    "debug",
    "info",
    "warning",
...
def test_bad_log_level():
    ...
    with patch.object(
        sys, "argv", ["bogus", "--log-level=emergency", "--token", github_pat]
    ):
        return_code = None
        try:
            terraform_to_secrets.cli.main()
