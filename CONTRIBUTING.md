...
issue](https://github.com/cisagov/terraform-to-secrets/issues) in
...
request](https://github.com/cisagov/terraform-to-secrets/pulls),
...
```console
cd terraform-to-secrets
pyenv virtualenv <python_version_to_use> terraform-to-secrets
pyenv local terraform-to-secrets
